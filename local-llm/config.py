...
class LocalLLMSettings(BaseSettings):
    ...
    project_root: str = Field(default="", validation_alias="PROJECT_ROOT")
    app_url_harvester: str = Field(
        default="http://127.0.0.1:8765",
        validation_alias="APP_URL_HARVESTER",
    )
    inject_project_context_in_chat: bool = Field(
        default=True,
        validation_alias="INJECT_PROJECT_CONTEXT_IN_CHAT",
    )
