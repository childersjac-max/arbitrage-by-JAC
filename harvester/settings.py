...
class HarvesterSettings(BaseSettings):
    ...
    polymarket_enabled: bool = Field(default=True, validation_alias="POLYMARKET_ENABLED")
    ...
    polymarket_market_limit: int = Field(default=100, validation_alias="POLYMARKET_MARKET_LIMIT")
    polymarket_use_orderbook: bool = Field(
        default=False,
        validation_alias="POLYMARKET_USE_ORDERBOOK",
    )
